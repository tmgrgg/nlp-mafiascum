...
\title{Detecting Deception in Online Mafia Games using Deep Learning architectures}

\author{Tom Grigg \\
  \texttt{tom.grigg.19@ucl.ac.uk} \\
  \And
  Kelvin Ng \\
  \texttt{kelvin.ng@ucl.ac.uk} \\
  \And
  Ritwick Sundar \\
  \texttt{ritwick.sundar.19@ucl.ac.uk}  \\
  \And
  Nicolas Ward \\
  \texttt{nicolas.ward.19@ucl.ac.uk}
}
